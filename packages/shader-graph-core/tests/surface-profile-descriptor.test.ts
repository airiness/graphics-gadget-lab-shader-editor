...
/**
 * Synthetic v1 descriptor mirroring the canonical main-repo instance field
 * for field (same vocabulary, same values). Embedded here rather than
 * mirrored from the main repository so the fixture stays deterministic and
 * self-contained.
 */
